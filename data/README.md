...
\f0\fs24 \cf0 Supplementary data  from Ider Chitham et al. 2020 - \'93Cosmological constraints from CODEX galaxy clusters spectroscopically confirmed by SDSS-IV/SPIDERS DR16\'94\
\
...
\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0
\cf0 * The cluster catalogue is sorted by `lnlike` which is the total log-likelihood of the cluster. This is the sum of the cluster membership log-likelihood `lnlamlike` and the log-likelihood of the central galaxy `lncglike`. The reason for doing this, is because the total log-likelihood is what is maximised when `redmapper` is run in scanning mode and it is also used to rank clusters during the percolation process.\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0
\cf0 \
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0
\cf0 * There are several different versions of the cluster redshift (and uncertainties) in the catalogue. Here they are listed in descending order of recommended usage:\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0
\cf0 \
